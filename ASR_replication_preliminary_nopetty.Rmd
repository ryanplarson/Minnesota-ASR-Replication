...
monsanc.short <- monsanc.short %>% 
  ...
  filter(felony_flag==1|gm_flag==1|misdem_flag==1) #charge degree filter: no sole pettys
```
...
stargazer(as.data.frame(
  monsanc.short[,c("total_ff",
          ...
          type="latex", style="asr", title="Descriptive Statistics - Felony, GM, and Misdem. Data",
...
corr<-round(cor(monsanc.short[,c("total_ff",
                                  ...
                                  "black","hispanic","nativeam","other.race",
                                  "trial_flag", "petty_flag","misdem_flag", "gm_flag", "felony_flag",
                                  "violent_flag","alcohol_flag","drug_flag", "violent_flag",
...
rownames(upper) <- c("Total Fine/Fee", "Priors", "Age", 
                                                  "Male", "White","Asian", "Black", 
                                                  "Hispanic", "Native Am.", "Other Race", "Trial", 
                                                  "Petty Misdmeanor", "Misdemenor", 
                                                  "Gross Misdemeanor", "Felony", 
                                                  "Violent","Alcohol/DUI", "Drug", "Hunt/Fish", 
                                                  "Violent", "Percent Minority", 
                                                  "Percent Vote Republican", "Percent Law and Justice")
```
...
means.all #white highest total_ff 
...
stargazer(m31, m32, m33, m34,
          ...
          covariate.labels = c("Black", "Hispanic", "Asian", "Native Am.", "Other Race", 
                               "Male", "log(Age)", "Priors", "Trial", "Petty Misdemeanor",
...
m41 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
              black_perc+repubvote+lecperc+(1|filed_county), REML = F, data = monsanc.short)
class(m41) <- "lmerMod" 

m42 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
               black_perc+repubvote+lecperc+black_perc:black+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m42) <- "lmerMod" 

m43 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
               black_perc+repubvote+lecperc+violent_flag:black+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m43) <- "lmerMod" 

m44 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
...
stargazer(m41, m42, m43, m44,
          ...
          covariate.labels = c("Priors", "Age", 
                               "Male",  "Black",  "Trial",  "Violent", "Petty Misdemeanor",
                               "Misdemeanor", "Gross Misdemeanor", "Felony",
                               "Percent Black", 
                               "Percent Vote Republican", "Percent Law and Justice",
...
m51 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
               hisp_perc+repubvote+lecperc+(1|filed_county), REML = F, data = monsanc.short)
class(m51) <- "lmerMod" 


m52 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
               hisp_perc+repubvote+lecperc+hisp_perc:hispanic+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m52) <- "lmerMod" 

m53 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
               hisp_perc+repubvote+lecperc+drug_flag:hispanic+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m53) <- "lmerMod" 

m54 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
...
stargazer(m51, m52, m53, m54,
          ...
          covariate.labels = c("Priors", "Age", 
                               "Male",  "Hispanic",  "Trial", "Drug", "Petty Misdemeanor",
                               "Misdemeanor", "Gross Misdemeanor", "Felony",
                                "Percent Hispanic", 
                               "Percent Vote Republican", "Percent Law and Justice",
...
m61 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
...
m62 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
                alcohol_flag+hf_flag+
...
m63 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
                alcohol_flag+hf_flag+
...
m64 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+
              petty_flag+misdem_flag+gm_flag+felony_flag+
                alcohol_flag+hf_flag+
...
stargazer(m61, m62, m63, m64,
          ...
          covariate.labels = c("Priors", "Age", 
                               "Male",  "Native Am.",  "Trial", "Petty Misdemeanor",
                               "Misdemeanor", "Gross Misdemeanor", "Felony",
