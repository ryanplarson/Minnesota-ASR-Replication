---
title: "ASR Replication Preliminary - No Petty Misdemeanors"
...
stargazer(as.data.frame(
  monsanc.short[,c("total_ff",
                                  ...
                                  "trial_flag", "mis", "gross.mis", "felony",
                                  "violent","alcohol.dui","drug",
...
stargazer(m31, m32, m33, m34,
          ...
          covariate.labels = c("Black", "Hispanic", "Asian", "Native Am.", "Other Race", 
                               ...
                               "Drug", "Alcohol.DUI",  "Hunt.Fish", "Other Offense", "Percent Minority", 
                               "Percent Vote Republican", "Percent Law and Justice"),
...
m41 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent+mis+gross.mis+
              black_perc+repubvote+lecperc+(1|filed_county), REML = F, data = monsanc.short)
class(m41) <- "lmerMod" 

m42 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent+mis+gross.mis+
               black_perc+repubvote+lecperc+black_perc:black+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m42) <- "lmerMod" 

m43 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent+mis+gross.mis+
               black_perc+repubvote+lecperc+violent:black+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m43) <- "lmerMod" 

m44 <- lmer(total_ff_log ~ priors+log(age)+male+black+trial_flag+violent+mis+gross.mis+
...
m51 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug+mis+gross.mis+
               hisp_perc+repubvote+lecperc+(1|filed_county), REML = F, data = monsanc.short)
class(m51) <- "lmerMod" 


m52 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug+mis+gross.mis+
               hisp_perc+repubvote+lecperc+hisp_perc:hispanic+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m52) <- "lmerMod" 

m53 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug+mis+gross.mis+
               hisp_perc+repubvote+lecperc+drug:hispanic+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m53) <- "lmerMod" 

m54 <- lmer(total_ff_log ~ priors+log(age)+male+hispanic+trial_flag+drug+mis+gross.mis+
...
m61 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+mis+gross.mis+
                alcohol.dui+hunt.fish+
               na_perc+repubvote+lecperc+(1|filed_county), REML = F, data = monsanc.short)
class(m61) <- "lmerMod" 


m62 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+mis+gross.mis+
              alcohol.dui+hunt.fish+
               na_perc+repubvote+lecperc+na_perc:nativeam+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m62) <- "lmerMod" 

m63 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+mis+gross.mis+
              alcohol.dui+hunt.fish+
               na_perc+repubvote+lecperc+alcohol.dui:nativeam+hunt.fish:nativeam+(1|filed_county), 
             REML = F, data = monsanc.short)
class(m63) <- "lmerMod" 

m64 <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+mis+gross.mis+
              alcohol.dui+hunt.fish+
