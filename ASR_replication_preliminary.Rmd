...
m62f <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+alcohol.dui+
               na_perc+repubvote+lecperc+na_perc:nativeam+(1|filed_county), 
             REML = F, data = felony)
class(m62f) <- "lmerMod" 

m63f <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+alcohol.dui+
               na_perc+repubvote+lecperc+alcohol.dui:nativeam+hunt.fish:nativeam+(1|filed_county), 
             REML = F, data = felony)
class(m63f) <- "lmerMod" 

m64f <- lmer(total_ff_log ~ priors+log(age)+male+nativeam+trial_flag+alcohol.dui+
